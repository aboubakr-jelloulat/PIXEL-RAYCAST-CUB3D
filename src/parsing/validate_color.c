...
/*   Updated: 2025/08/27 16:06:28 by ajelloul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	validate_textures_and_colors(t_cub *cub)
{
	...
	{
		display_errors("\nConfiguration Error: Duplicate components detected\n");
		return (1);
	}
	if (cub->list_status.is_wrong_txtr_extension)
	{
		display_errors("\nColor Error: Floor color is missing or invalid\n");
		return (1);
	}
	...
	{
		display_errors("\nColor Error: Ceiling color is missing or invalid\n");
		return (1);
	}
	return (0);
}
